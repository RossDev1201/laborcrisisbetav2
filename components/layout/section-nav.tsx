...
const navItems: NavItem[] = [
  ...
  { id: "workforce-solutions", label: "Workforce solutions", icon: <FlagIcon /> },
  ...
  { id: "partners", label: "Partners", icon: <GlobeIcon /> },
  ...
  return (
    ...
    >
      {navItems.map((item, index) => {
        const href = index === 0 ? "#top" : `#${item.id}`;
...
/* --- Tiny inline SVG icons (unchanged) --- */
...
function ArrowUpIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={iconBase} fill="none">
      <path d="M8 13V3" />
